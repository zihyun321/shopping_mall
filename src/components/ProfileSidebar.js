...
const ProfileSidebar = props => {
    ...
    // const active = {     marginTop: '1px',     fontWeight: 'bold',     fontSize:
    // '16px', }
    ...
    const handleClickLink = (e) => {
        ...
        // getElementById로 css 지정하는법 알기 let selectedTag =
        // document.getElementById(e.target.id); selectedTag.className = 'active'
