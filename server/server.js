...
// Module 가져오기 const router = require('./routers');
...
// 수정전 app.post("/userJoin", router);       회원가입 app.post("/getProduct",
// router);     제품 정보 조회 app.post("/userLogin", router);      로그인
// app.post("/getUserInfo", router);    user 정보 조회 수정후 라우팅
